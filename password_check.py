...
downloaders.new_model.label_14.setText("로그인중...")
scope = [
    'https://spreadsheets.google.com/feeds',
    'https://www.googleapis.com/auth/drive',
]
...
if downloaders.new_model.lineEdit_11.text() == df_db['password'][0]:
    print("성공")
    downloaders.new_model.label_14.setText("로그인 성공")
    downloaders.new_model.label.setText("")
    downloaders.new_model.tab_2.setDisabled(False)
    downloaders.new_model.tab.setDisabled(True)

else:
    downloaders.new_model.label_14.setText("로그인 실패..\n비밀번호를 다시 입력해 주세요.")
